      ...
      assertions = [
        {
          ...
          message =
            with noxa.lib.ansi;
            "${bold + fgYellow}NixOS ${fgCyan}mine.${italic}persistence${fgYellow + noItalic} module option not found! Did you not import the ${fgCyan}mine.persistence${fgYellow} module?";
        }
      ];
