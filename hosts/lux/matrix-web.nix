...
with lib;
{
  config =
    let
      ...
      hostAddress6 = luxAddr6For "fc00::/64" "mtx-web-veth-host";
      containerAddr = config.containers.mtx-web.localAddress6;
    in
    {
      ...
      containers.mtx-web = {
        ...
        localAddress6 = luxAddr6For luxPublicNetwork6 "mtx-web";
        ephemeral = true;
        inherit specialArgs;
